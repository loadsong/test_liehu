...
app.controller('customersCtrl', function($scope, $http) {
    ...
    $scope.myFunc = function() {
        $http({
            method: 'GET',
            url: '/queryAll/queryAllById',
            params:{author:$scope.selectedName}
        })
...
app.config(['$routeProvider', function($routeProvider){
    $routeProvider
        .when('/committer',{templateUrl:'author.html'})
        .when('/weekall',{templateUrl:'weekall.html'})
